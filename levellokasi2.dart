...
class levelLokasi2 extends StatefulWidget {
  @override
  levelLokasi2State createState() => levelLokasi2State();
}

class levelLokasi2State extends State<StatefulWidget> {
  //List _listLokasi = ['a', 'b', 'c', 'd', 'e'];
        ...
        children: [
          ...
          TextButton(
            onPressed: () {
              setState(() {
                reset = true;
                SharePreferencesHelper.saveIsFilter(false);
            ...
            onPressed: () {
              setState(() {
                ...
                if (_keywordPencarian.text.length >= 1) {
                  SharePreferencesHelper.saveCariLokasi(_keywordPencarian.text);
                  ...
                  // }
                  SharePreferencesHelper.saveIsFilter(true);
                  Navigator.of(context)
                      .pushReplacement(MaterialPageRoute(builder: (_) {
                    return levelLokasi();
                  }));
  ...
  void cariLevelLokasi() async {
    if (_keywordPencarian.text.isEmpty) {
      //tidak filter dari kata pencarian
    } else {
      //masuk ke API ->
      //await ListLevelLokasiViewmodel().
    }
  }
}
